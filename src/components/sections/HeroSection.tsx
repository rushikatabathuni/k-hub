      ...
      <div className="relative container mx-auto px-4 lg:px-8 py-20 lg:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-gradient text-glow-primary">Future</span>
            <br />
            <span className="text-foreground">Through </span>
            <span className="text-gradient-reverse">Innovation</span>
          </motion.h1>
          ...
          >
            ...
            empowering students to work on cutting-edge research in drug discovery, 
